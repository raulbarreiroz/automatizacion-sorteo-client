...
export default function IniciarSesion() {  
  ...
  const [mostrarDialogCrearUsuario, setMostrarDialogCrearUsuario] = useState(false)
  ...
  return (
    ...
    <ThemeProvider theme={defaultTheme}>
      <Container component="main" maxWidth="xs">
        ...
        >
          <Avatar variant="rounded" sx={{ width: '100%', height: '100%', m:1 }} src='https://upload.wikimedia.org/wikipedia/commons/9/99/Logo_UCSG.svg' alt='logo-UCSG' />            
    ...
    <DialogCrearUsuario mostrarDialogCrearUsuario={mostrarDialogCrearUsuario} setMostrarDialogCrearUsuario={setMostrarDialogCrearUsuario}/>        
    </>
  );
}